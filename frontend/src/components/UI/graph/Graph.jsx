...
const Graph = (props) => {
    ...
    y *= 30;
    r *= 30;
    const circle = "M150," + (150 - r / 2).toString() + " A" + (r / 2).toString() + "," + (r).toString() + " 90 0,1 " + (150 + r / 2).toString() + ",150 L 150,150 Z";
    const triangle = "M 150 150 L " + (150 + r / 2).toString() + " 150 L 150 " + (150 + r / 2).toString() + " z";
    return (
        <div className={classes.graph}>
            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <rect x={150 - r} y={150} width={r} height={r} fill="#FF2E63"/>
